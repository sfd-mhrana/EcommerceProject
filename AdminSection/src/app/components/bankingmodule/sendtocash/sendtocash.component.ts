...
@Component({
  selector: 'app-sendtocash',
  templateUrl: './sendtocash.component.html',
  styleUrls: ['./sendtocash.component.css']
})
export class SendtocashComponent implements OnInit {
    ...
    this.form = this.formBuilder.group(
      {
        ...
        details: ['Withdraw To Shop', Validators.required],
        amount: [null, Validators.required],
        Status: ['Devit', Validators.required],
      }
    )
  }
  ...
  onSubmit() {
    if (this.validfrom()) {
      ...
      fromdata.append('cashstatus','Credit');
      fromdata.append('type', 'Shop');
